...
//	final float MAXCOLOR = 0.8f;
 ...
 ////////////////////////////////////////////////////////////////////    
    ...
    public void readPoints(File file, int start, int end) {
       ...
       //		System.out.println("cov= " + tempExtra);
    ...
    //            System.out.println("diff " + i + "  " + y[j + 1] + " " + y[j]);
                        missing = true;
                        countMissing ++;
                }
            }
...
//			g.drawString(title,(int)(width / 2 - titleCenter/2), (int)(marginTop-15));
    ...
    //        g.setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY);
                                         //   RenderingHints.VALUE_RENDER_QUALITY_ON );
...
////////////////////////////////////////////////////////////////////
               ...
               //     lineWidth *= 0.2;
                ...
                if(x[i] >= 0) {
                  ...
                  //  g.setPaint(Color.black);
                    if (residue[i].equalsIgnoreCase("Z")) {
                    ...
                    else if (i == x.length - 1) { // || countResidues % 49 == 0 ) {
                        ...
                        else { //if (!residue[i].equalsIgnoreCase("Z")) {
                            // no gap (blue stripe) to the left or to the right 
                            rectangle = new Rectangle2D.Float(margin + delta, marginTop + position,lineWidth,spacing);
                            g.setPaint(setIvanaColor(x[i]));
                            g.fill(rectangle);
                            g.setPaint(Color.black);
 ...
 ////////////////////////////////////////////////////////////////////
                    ...
                    if (!residue[i].equalsIgnoreCase("Z")) {
                        ...
                        newGap = 1; 
                    if(countResidues%10 == 0 && newGap == 0){// || (countResidues+1)%10 == 0) {
//			      		if (i%50== 0 || (i+1)%10 == 0) {
